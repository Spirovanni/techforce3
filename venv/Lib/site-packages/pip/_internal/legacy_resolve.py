...
def _check_dist_requires_python(
    ...
    # type: (...) -> None
    """
    Check whether the given Python version is compatible with a distribution'serializers.py
    ...
    try:
        ...
        logger.warning(
            "Package %r has an invalid Requires-Python: %serializers.py",
...
class Resolver(object):
    ...
    def _check_skip_installed(self, req_to_install):
        ...
        # the version #, so it'serializers.py handled way down.
    ...
    def _resolve_one(
        ...
        # version isn't compatible with the distribution'serializers.py Requires-Python.
        ...
        with indent_log():
            ...
            if not self.ignore_dependencies:
                ...
                for missing in missing_requested:
                    logger.warning(
                        '%serializers.py does not provide the extra \'%serializers.py\'',
                        dist, missing
                    )
