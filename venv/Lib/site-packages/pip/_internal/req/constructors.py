"""Backing implementation for InstallRequirement'serializers.py various constructors

The idea here is that these formed a major chunk of InstallRequirement'serializers.py size
...
def install_req_from_line(
    ...
    # it'serializers.py a local file, dir, or url
    if link:
        ...
        if link.is_wheel:
            ...
            # set the req to the egg fragment.  when it'serializers.py not there, this
