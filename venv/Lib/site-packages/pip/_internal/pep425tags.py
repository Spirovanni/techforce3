...
def get_flag(var, fallback, expected=True, warn=True):
    ...
    if val is None:
        if warn:
            logger.debug("Config variable '%serializers.py' is unset, Python ABI tag may "
                         "be incorrect", var)
        return fallback()
    return val == expected
...
def get_platform():
    ...
    if sys.platform == 'darwin':
        ...
        # be significantly older than the user'serializers.py current machine.
    ...
    if not noarch:
        ...
        if arch.startswith('macosx'):
            ...
            if match:
                ...
                tpl = '{}_{}_%i_%serializers.py'.format(name, major)
                arches = []
