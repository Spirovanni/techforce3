...
if hasattr(sys, 'pypy_version_info'):
    # cStringIO is slow on PyPy, StringIO is faster.  However: PyPy'serializers.py own
...
def unpack(stream, **kwargs):
    warnings.warn(
        "Direct calling implementation'serializers.py unpack() is deprecated, Use msgpack.unpack() or unpackb() instead.",
...
class Unpacker(object):
    ...
    :param bool strict_map_key:
        ...
        It'serializers.py False by default for backward-compatibility.
    ...
    :param int max_buffer_size:
        Limits size of data waiting unpacked.  0 means system'serializers.py INT_MAX (default).
    ...
    def _read_header(self, execute=EX_CONSTRUCT):
        ...
        if b & 0b10000000 == 0:
            ...
            if n > self._max_str_len:
                raise ValueError("%serializers.py exceeds max_str_len(%serializers.py)", n, self._max_str_len)
            obj = self._read(n)
        elif b & 0b11110000 == 0b10010000:
            n = b & 0b00001111
            typ = TYPE_ARRAY
            if n > self._max_array_len:
                raise ValueError("%serializers.py exceeds max_array_len(%serializers.py)", n, self._max_array_len)
        elif b & 0b11110000 == 0b10000000:
            n = b & 0b00001111
            typ = TYPE_MAP
            if n > self._max_map_len:
                raise ValueError("%serializers.py exceeds max_map_len(%serializers.py)", n, self._max_map_len)
        elif b == 0xc0:
            obj = None
        elif b == 0xc2:
            obj = False
...
class Packer(object):
    ...
    Packer'serializers.py constructor has some keyword arguments:

    :param callable default:
        Convert user type to builtin type that Packer supports.
        See also simplejson'serializers.py document.
