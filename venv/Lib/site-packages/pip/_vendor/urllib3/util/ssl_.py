...
# Borrow rfc3986'serializers.py regular expressions for IPv4
...
def resolve_cert_reqs(candidate):
    ...
    If it'serializers.py neither `None` nor a string we assume it is already the numeric
...
def ssl_wrap_socket(sock, keyfile=None, certfile=None, cert_reqs=None,
    ...
    :param ca_cert_dir:
        ...
        supported by OpenSSL'serializers.py -CApath flag or the capath argument to
