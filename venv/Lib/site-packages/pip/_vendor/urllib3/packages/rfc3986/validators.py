...
def ensure_one_of(allowed_values, uri, attribute):
    """Assert that the uri'serializers.py attribute is one of the allowed values."""
...
def subauthority_component_is_valid(uri, component):
    ...
    # validating the port, we can assume it'serializers.py valid.
    if component == 'host':
...
def ensure_components_are_valid(uri, validated_components):
    ...
    for component in validated_components:
        if component in _SUBAUTHORITY_VALIDATORS:
            ...
            # Python'serializers.py peephole optimizer means that while this continue *is*
