...
variations = [
    #                            6( h16 ":" ) ls32
    '(%(hex)serializers.py:){6}%(ls32)serializers.py' % _subs,
    #                       "::" 5( h16 ":" ) ls32
    '::(%(hex)serializers.py:){5}%(ls32)serializers.py' % _subs,
    # [               h16 ] "::" 4( h16 ":" ) ls32
    '(%(hex)serializers.py)?::(%(hex)serializers.py:){4}%(ls32)serializers.py' % _subs,
    # [ *1( h16 ":" ) h16 ] "::" 3( h16 ":" ) ls32
    '((%(hex)serializers.py:)?%(hex)serializers.py)?::(%(hex)serializers.py:){3}%(ls32)serializers.py' % _subs,
    # [ *2( h16 ":" ) h16 ] "::" 2( h16 ":" ) ls32
    '((%(hex)serializers.py:){0,2}%(hex)serializers.py)?::(%(hex)serializers.py:){2}%(ls32)serializers.py' % _subs,
    # [ *3( h16 ":" ) h16 ] "::"    h16 ":"   ls32
    '((%(hex)serializers.py:){0,3}%(hex)serializers.py)?::%(hex)serializers.py:%(ls32)serializers.py' % _subs,
    # [ *4( h16 ":" ) h16 ] "::"              ls32
    '((%(hex)serializers.py:){0,4}%(hex)serializers.py)?::%(ls32)serializers.py' % _subs,
    # [ *5( h16 ":" ) h16 ] "::"              h16
    '((%(hex)serializers.py:){0,5}%(hex)serializers.py)?::%(hex)serializers.py' % _subs,
    # [ *6( h16 ":" ) h16 ] "::"
    '((%(hex)serializers.py:){0,6}%(hex)serializers.py)?::' % _subs,
]
...
PATH_EMPTY = '^$'
PATH_ROOTLESS = '%(segment-nz)serializers.py(/%(segment)serializers.py)*' % segments
PATH_NOSCHEME = '%(segment-nz-nc)serializers.py(/%(segment)serializers.py)*' % segments
PATH_ABSOLUTE = '/(%s)?' % PATH_ROOTLESS
PATH_ABEMPTY = '(/%(segment)serializers.py)*' % segments
PATH_RE = '^(%s|%s|%s|%s|%s)$' % (
...
IPATH_ROOTLESS = u'%(isegment-nz)serializers.py(/%(isegment)serializers.py)*' % isegments
IPATH_NOSCHEME = u'%(isegment-nz-nc)serializers.py(/%(isegment)serializers.py)*' % isegments
IPATH_ABSOLUTE = u'/(?:%s)?' % IPATH_ROOTLESS
IPATH_ABEMPTY = u'(?:/%(isegment)serializers.py)*' % isegments
