...
It is the recommended replacement for Python'serializers.py original
...
class LinuxDistribution(object):
    ...
    def linux_distribution(self, full_distribution_name=True):
        ...
        with Python'serializers.py :func:`platform.linux_distribution`, supporting a subset
        of its parameters.
...
def main():
    ...
    if args.json:
        ...
        logger.info('Name: %serializers.py', name(pretty=True))
        distribution_version = version(pretty=True)
        logger.info('Version: %serializers.py', distribution_version)
        distribution_codename = codename()
        logger.info('Codename: %serializers.py', distribution_codename)
