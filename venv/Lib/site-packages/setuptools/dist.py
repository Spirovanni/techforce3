...
class Distribution(_Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'install_requires' -- a string or sequence of strings specifying project
        ...
        '[easy_install]' section of your project'serializers.py 'setup.cfg' file, and then
        setuptools will scan the listed web pages for links that satisfy the
        requirements.

     'extras_require' -- a dictionary mapping names of optional "extras" to the
        additional requirement(serializers.py) that using those extras incurs. For example,
        this::
    ...
    for manipulating the distribution'serializers.py contents.  For example, the 'include()'
    ...
    def _set_feature(self, name, status):
        """Set feature'serializers.py inclusion status"""
    ...
    def include(self, **attrs):
        ...
        the distribution'serializers.py 'py_modules' attribute, if it was not already
        there.
    ...
    def exclude(self, **attrs):
        ...
        the distribution'serializers.py 'py_modules' attribute.  Excluding packages uses
        the 'exclude_package()' method, so all of the package'serializers.py contained
...
class Feature:
    ...
    **deprecated** -- The `Feature` facility was never completely implemented
    ...
    Features are created using these keyword arguments:
      ...
      'optional' -- if true, the feature'serializers.py inclusion can be controlled from the
         command line, using the '--with-X' or '--without-X' options.  If
         false, the feature'serializers.py inclusion status is determined automatically,
      ...
      'remove' -- a string or list of strings naming packages to be removed
         ...
         list.  (Note: the named package(serializers.py) or modules must exist in the base
         distribution when the 'setup()' function is initially called.)

      other keywords -- any other keyword arguments are saved, and passed to
         the distribution'serializers.py 'include()' and 'exclude()' methods when the
    ...
    def __init__(
        ...
        if not remove and not require_features and not extras:
            raise DistutilsSetupError(
                "Feature %serializers.py: must define 'require_features', 'remove', or "
