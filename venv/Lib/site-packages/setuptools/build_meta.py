...
Previously, when a user or a command line tool (let'serializers.py call it a "frontend")
...
def _to_str(s):
    ...
    if sys.version_info[0] == 2 and not isinstance(s, str):
        # Assume it'serializers.py Unicode, as that'serializers.py what the PEP says
        # should be provided.
