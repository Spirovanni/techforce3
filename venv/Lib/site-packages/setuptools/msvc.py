...
class EnvironmentInfo:
    ...
    def VCTools(self):
        ...
        if self.vc_ver == 14.0:
            ...
            host_dir = (r'bin\HostX86%serializers.py' if self.pi.current_is_x86() else
                        r'bin\HostX64%serializers.py')
            tools += [os.path.join(
    ...
    def VCRuntimeRedist(self):
        ...
        if self.vc_ver < 15:
            ...
            vcruntime = 'redist%serializers.py\\Microsoft.VC%d0.CRT\\vcruntime%d0.dll'
        else:
            redist_path = self.si.VCInstallDir.replace('\\Tools', '\\Redist')
            vcruntime = 'onecore%serializers.py\\Microsoft.VC%d0.CRT\\vcruntime%d0.dll'
